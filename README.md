  ...
  "Detail": {
    ...
    /*
      The workflow run name takes the following format
        ...
        - bsshfastqcopy (is the workflow name in lower case (hard-coded)
    ...
    */
    "workflowRunName": "umccr--automated--bsshfastqcopy--2025-05-14--202504179cac7411",
    "payload": {
...
{
  "EventBusName": "OrcaBusMain",  // Name of the event bus
  "DetailType": "WorkflowRunStateChange",  // Workflow Manager event type
  "Source": "orcabus.workflowmanager",  // Event relayed by the workflow manager
  "Detail": {
    "status": "SUCCEEDED",  // Workflow run status
    "timestamp": "2025-04-22T00:09:07.220Z",  // Timestamp of the event
    "portalRunId": "202504179cac7411",  // Portal Run ID For the BSSH Fastq Copy Manager  // pragma: allowlist secret
    "workflowName": "bsshFastqCopy",  // Workflow name
    "workflowVersion": "1.0.0",  // Workflow version
    "workflowRunName": "umccr--automated--bsshfastqcopy--2024-05-24--202504179cac7411",  // Workflow run name
